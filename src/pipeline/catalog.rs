...
const ACTIONS: &[ActionAd] = &[
    ActionAd {
        ...
        when_to_use: "Noisy terminal logs, pretty-printed JSON, spinner spam",
    ...
    ActionAd {
        ...
        when_to_use: "Bulky blobs you still need to understand",
    ...
    ActionAd {
        ...
        when_to_use: "CLI tool dumps with known boilerplate",
        fields: "text, output?",
    ...
    ActionAd {
        ...
        when_to_use: "Audit how much you saved this session",
        fields: "reset?",
    ...
    ActionAd {
        ...
        when_to_use: "Untrusted tool/web output before the model sees it",
    ...
    ActionAd {
        ...
        when_to_use: "Unknown which action to pick — discover first",
        fields: "(none)",
